...
- 2: Перевести `userMeals.jsp` на работу по ajax. Стиль строки таблицы сделать в зависимости от `excess`, время отображать без `T`. Добавить i18n.
- 3: Починить userMeals тесты, добавить тест на неавторизованный доступ
...
- 8: Проверьте в `RootController.userMeals()`, его нужно тоже поправить
