...
<div class="jumbotron pt-0">
    <div class="container">
        ...
        <br/>
        <p>
            <button type="submit" class="btn btn-sm btn-primary" onclick="login('user@yandex.ru', 'password')">
                <spring:message code="app.login"/> User
            </button>
            <button type="submit" class="btn btn-sm btn-primary" onclick="login('admin@gmail.com', 'admin')">
